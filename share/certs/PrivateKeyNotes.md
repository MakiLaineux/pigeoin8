...
allowing somebody to distribute a Bitcoin-Qt.app or pigeoin-qt-setup.exe with a valid
...
that the pigeoin-qt.exe file inside the installer had not been tampered with.

...
#ifndef H_PIGEOIN_SCRIPT
#define H_PIGEOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CPigeoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Pigeoin always counted CHECKMULTISIGs

...
static const char *strMainNetDNSSeed[][2] = {
    {"pigeoin.sipa.be", "seed.pigeoin.sipa.be"},
    {"bluematt.me", "dnsseed.bluematt.me"},
    {"dashjr.org", "dnsseed.pigeoin.dashjr.org"},
    {"xf2.org", "bitseed.xf2.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"pigeoin.petertodd.org", "testnet-seed.pigeoin.petertodd.org"},

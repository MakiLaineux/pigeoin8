...
public:
    ...
    PigeoinAmountField *transactionFee;
    QSpacerItem *horizontalSpacer_1_Main;
    QCheckBox *pigeoinAtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        transactionFee = new PigeoinAmountField(tabMain);
        ...
        pigeoinAtStartup = new QCheckBox(tabMain);
        pigeoinAtStartup->setObjectName(QString::fromUtf8("pigeoinAtStartup"));

        verticalLayout_Main->addWidget(pigeoinAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        pigeoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Pigeoin after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        pigeoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Pigeoin on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Pigeoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Pigeoin network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Pigeoin.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show Pigeoin addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP

#############################################################################
# Makefile for building: pigeoin-qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Mon Mar 26 21:15:29 2018
# Project:  pigeoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake USE_UPNP=- -o Makefile pigeoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu /home/ulysse/source/pigeoin-0.8/src/leveldb/libleveldb.a /home/ulysse/source/pigeoin-0.8/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/qt/pigeoin.cpp \
		...
		src/leveldb.cpp \
		src/txdb.cpp \
		src/qt/splashscreen.cpp build/moc_pigeoingui.cpp \
		...
		build/moc_pigeoinaddressvalidator.cpp \
		...
		build/moc_pigeoinamountfield.cpp \
...
OBJECTS       = build/pigeoin.o \
		...
		build/pigeoinaddressvalidator.o \
		build/alert.o \
		build/version.o \
		build/sync.o \
		build/util.o \
		...
		build/pigeoinstrings.o \
		build/pigeoinamountfield.o \
		build/wallet.o \
		build/keystore.o \
		...
		build/moc_pigeoinaddressvalidator.o \
		...
		build/moc_pigeoinamountfield.o \
...
$(TARGET): /home/ulysse/source/pigeoin-0.8/src/leveldb/libleveldb.a /home/ulysse/source/pigeoin-0.8/build/build.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: pigeoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile pigeoin-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/pigeoin-qt0.8.6 || $(MKDIR) build/pigeoin-qt0.8.6 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/pigeoin-qt0.8.6/ && $(COPY_FILE) --parents src/qt/locale/pigeoin_af_ZA.ts src/qt/locale/pigeoin_ar.ts src/qt/locale/pigeoin_bg.ts src/qt/locale/pigeoin_bs.ts src/qt/locale/pigeoin_ca.ts src/qt/locale/pigeoin_ca_ES.ts src/qt/locale/pigeoin_cs.ts src/qt/locale/pigeoin_cy.ts src/qt/locale/pigeoin_da.ts src/qt/locale/pigeoin_de.ts src/qt/locale/pigeoin_el_GR.ts src/qt/locale/pigeoin_en.ts src/qt/locale/pigeoin_eo.ts src/qt/locale/pigeoin_es.ts src/qt/locale/pigeoin_es_CL.ts src/qt/locale/pigeoin_et.ts src/qt/locale/pigeoin_eu_ES.ts src/qt/locale/pigeoin_fa.ts src/qt/locale/pigeoin_fa_IR.ts src/qt/locale/pigeoin_fi.ts src/qt/locale/pigeoin_fr.ts src/qt/locale/pigeoin_fr_CA.ts src/qt/locale/pigeoin_gu_IN.ts src/qt/locale/pigeoin_he.ts src/qt/locale/pigeoin_hi_IN.ts src/qt/locale/pigeoin_hr.ts src/qt/locale/pigeoin_hu.ts src/qt/locale/pigeoin_it.ts src/qt/locale/pigeoin_ja.ts src/qt/locale/pigeoin_la.ts src/qt/locale/pigeoin_lt.ts src/qt/locale/pigeoin_lv_LV.ts src/qt/locale/pigeoin_nb.ts src/qt/locale/pigeoin_nl.ts src/qt/locale/pigeoin_pl.ts src/qt/locale/pigeoin_pt_BR.ts src/qt/locale/pigeoin_pt_PT.ts src/qt/locale/pigeoin_ro_RO.ts src/qt/locale/pigeoin_ru.ts src/qt/locale/pigeoin_sk.ts src/qt/locale/pigeoin_sr.ts src/qt/locale/pigeoin_sv.ts src/qt/locale/pigeoin_th_TH.ts src/qt/locale/pigeoin_tr.ts src/qt/locale/pigeoin_uk.ts src/qt/locale/pigeoin_zh_CN.ts src/qt/locale/pigeoin_zh_TW.ts build/pigeoin-qt0.8.6/ && $(COPY_FILE) --parents src/qt/pigeoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/pigeoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/pigeoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/pigeoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/pigeoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/splashscreen.h build/pigeoin-qt0.8.6/ && $(COPY_FILE) --parents src/qt/pigeoin.qrc build/pigeoin-qt0.8.6/ && $(COPY_FILE) --parents src/qt/pigeoin.cpp src/qt/pigeoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/pigeoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/pigeoinstrings.cpp src/qt/pigeoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/pigeoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/pigeoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp build/pigeoin-qt0.8.6/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui build/pigeoin-qt0.8.6/ && $(COPY_FILE) --parents src/qt/locale/pigeoin_af_ZA.ts src/qt/locale/pigeoin_ar.ts src/qt/locale/pigeoin_bg.ts src/qt/locale/pigeoin_bs.ts src/qt/locale/pigeoin_ca.ts src/qt/locale/pigeoin_ca_ES.ts src/qt/locale/pigeoin_cs.ts src/qt/locale/pigeoin_cy.ts src/qt/locale/pigeoin_da.ts src/qt/locale/pigeoin_de.ts src/qt/locale/pigeoin_el_GR.ts src/qt/locale/pigeoin_en.ts src/qt/locale/pigeoin_eo.ts src/qt/locale/pigeoin_es.ts src/qt/locale/pigeoin_es_CL.ts src/qt/locale/pigeoin_et.ts src/qt/locale/pigeoin_eu_ES.ts src/qt/locale/pigeoin_fa.ts src/qt/locale/pigeoin_fa_IR.ts src/qt/locale/pigeoin_fi.ts src/qt/locale/pigeoin_fr.ts src/qt/locale/pigeoin_fr_CA.ts src/qt/locale/pigeoin_gu_IN.ts src/qt/locale/pigeoin_he.ts src/qt/locale/pigeoin_hi_IN.ts src/qt/locale/pigeoin_hr.ts src/qt/locale/pigeoin_hu.ts src/qt/locale/pigeoin_it.ts src/qt/locale/pigeoin_ja.ts src/qt/locale/pigeoin_la.ts src/qt/locale/pigeoin_lt.ts src/qt/locale/pigeoin_lv_LV.ts src/qt/locale/pigeoin_nb.ts src/qt/locale/pigeoin_nl.ts src/qt/locale/pigeoin_pl.ts src/qt/locale/pigeoin_pt_BR.ts src/qt/locale/pigeoin_pt_PT.ts src/qt/locale/pigeoin_ro_RO.ts src/qt/locale/pigeoin_ru.ts src/qt/locale/pigeoin_sk.ts src/qt/locale/pigeoin_sr.ts src/qt/locale/pigeoin_sv.ts src/qt/locale/pigeoin_th_TH.ts src/qt/locale/pigeoin_tr.ts src/qt/locale/pigeoin_uk.ts src/qt/locale/pigeoin_zh_CN.ts src/qt/locale/pigeoin_zh_TW.ts build/pigeoin-qt0.8.6/ && (cd `dirname build/pigeoin-qt0.8.6` && $(TAR) pigeoin-qt0.8.6.tar pigeoin-qt0.8.6 && $(COMPRESS) pigeoin-qt0.8.6.tar) && $(MOVE) `dirname build/pigeoin-qt0.8.6`/pigeoin-qt0.8.6.tar.gz . && $(DEL_FILE) -r build/pigeoin-qt0.8.6


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/ulysse/source/pigeoin-0.8/src/leveldb/libleveldb.a; cd /home/ulysse/source/pigeoin-0.8/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/ulysse/source/pigeoin-0.8/src/leveldb/libleveldb.a: FORCE
	cd /home/ulysse/source/pigeoin-0.8/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/ulysse/source/pigeoin-0.8/build/build.h: FORCE
	cd /home/ulysse/source/pigeoin-0.8; /bin/sh share/genbuild.sh /home/ulysse/source/pigeoin-0.8/build/build.h
...
compiler_TSQM_make_all: src/qt/locale/pigeoin_af_ZA.qm src/qt/locale/pigeoin_ar.qm src/qt/locale/pigeoin_bg.qm src/qt/locale/pigeoin_bs.qm src/qt/locale/pigeoin_ca.qm src/qt/locale/pigeoin_ca_ES.qm src/qt/locale/pigeoin_cs.qm src/qt/locale/pigeoin_cy.qm src/qt/locale/pigeoin_da.qm src/qt/locale/pigeoin_de.qm src/qt/locale/pigeoin_el_GR.qm src/qt/locale/pigeoin_en.qm src/qt/locale/pigeoin_eo.qm src/qt/locale/pigeoin_es.qm src/qt/locale/pigeoin_es_CL.qm src/qt/locale/pigeoin_et.qm src/qt/locale/pigeoin_eu_ES.qm src/qt/locale/pigeoin_fa.qm src/qt/locale/pigeoin_fa_IR.qm src/qt/locale/pigeoin_fi.qm src/qt/locale/pigeoin_fr.qm src/qt/locale/pigeoin_fr_CA.qm src/qt/locale/pigeoin_gu_IN.qm src/qt/locale/pigeoin_he.qm src/qt/locale/pigeoin_hi_IN.qm src/qt/locale/pigeoin_hr.qm src/qt/locale/pigeoin_hu.qm src/qt/locale/pigeoin_it.qm src/qt/locale/pigeoin_ja.qm src/qt/locale/pigeoin_la.qm src/qt/locale/pigeoin_lt.qm src/qt/locale/pigeoin_lv_LV.qm src/qt/locale/pigeoin_nb.qm src/qt/locale/pigeoin_nl.qm src/qt/locale/pigeoin_pl.qm src/qt/locale/pigeoin_pt_BR.qm src/qt/locale/pigeoin_pt_PT.qm src/qt/locale/pigeoin_ro_RO.qm src/qt/locale/pigeoin_ru.qm src/qt/locale/pigeoin_sk.qm src/qt/locale/pigeoin_sr.qm src/qt/locale/pigeoin_sv.qm src/qt/locale/pigeoin_th_TH.qm src/qt/locale/pigeoin_tr.qm src/qt/locale/pigeoin_uk.qm src/qt/locale/pigeoin_zh_CN.qm src/qt/locale/pigeoin_zh_TW.qm
compiler_TSQM_clean:
	-$(DEL_FILE) src/qt/locale/pigeoin_af_ZA.qm src/qt/locale/pigeoin_ar.qm src/qt/locale/pigeoin_bg.qm src/qt/locale/pigeoin_bs.qm src/qt/locale/pigeoin_ca.qm src/qt/locale/pigeoin_ca_ES.qm src/qt/locale/pigeoin_cs.qm src/qt/locale/pigeoin_cy.qm src/qt/locale/pigeoin_da.qm src/qt/locale/pigeoin_de.qm src/qt/locale/pigeoin_el_GR.qm src/qt/locale/pigeoin_en.qm src/qt/locale/pigeoin_eo.qm src/qt/locale/pigeoin_es.qm src/qt/locale/pigeoin_es_CL.qm src/qt/locale/pigeoin_et.qm src/qt/locale/pigeoin_eu_ES.qm src/qt/locale/pigeoin_fa.qm src/qt/locale/pigeoin_fa_IR.qm src/qt/locale/pigeoin_fi.qm src/qt/locale/pigeoin_fr.qm src/qt/locale/pigeoin_fr_CA.qm src/qt/locale/pigeoin_gu_IN.qm src/qt/locale/pigeoin_he.qm src/qt/locale/pigeoin_hi_IN.qm src/qt/locale/pigeoin_hr.qm src/qt/locale/pigeoin_hu.qm src/qt/locale/pigeoin_it.qm src/qt/locale/pigeoin_ja.qm src/qt/locale/pigeoin_la.qm src/qt/locale/pigeoin_lt.qm src/qt/locale/pigeoin_lv_LV.qm src/qt/locale/pigeoin_nb.qm src/qt/locale/pigeoin_nl.qm src/qt/locale/pigeoin_pl.qm src/qt/locale/pigeoin_pt_BR.qm src/qt/locale/pigeoin_pt_PT.qm src/qt/locale/pigeoin_ro_RO.qm src/qt/locale/pigeoin_ru.qm src/qt/locale/pigeoin_sk.qm src/qt/locale/pigeoin_sr.qm src/qt/locale/pigeoin_sv.qm src/qt/locale/pigeoin_th_TH.qm src/qt/locale/pigeoin_tr.qm src/qt/locale/pigeoin_uk.qm src/qt/locale/pigeoin_zh_CN.qm src/qt/locale/pigeoin_zh_TW.qm
src/qt/locale/pigeoin_af_ZA.qm: src/qt/locale/pigeoin_af_ZA.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_af_ZA.ts -qm src/qt/locale/pigeoin_af_ZA.qm

src/qt/locale/pigeoin_ar.qm: src/qt/locale/pigeoin_ar.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_ar.ts -qm src/qt/locale/pigeoin_ar.qm

src/qt/locale/pigeoin_bg.qm: src/qt/locale/pigeoin_bg.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_bg.ts -qm src/qt/locale/pigeoin_bg.qm

src/qt/locale/pigeoin_bs.qm: src/qt/locale/pigeoin_bs.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_bs.ts -qm src/qt/locale/pigeoin_bs.qm

src/qt/locale/pigeoin_ca.qm: src/qt/locale/pigeoin_ca.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_ca.ts -qm src/qt/locale/pigeoin_ca.qm

src/qt/locale/pigeoin_ca_ES.qm: src/qt/locale/pigeoin_ca_ES.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_ca_ES.ts -qm src/qt/locale/pigeoin_ca_ES.qm

src/qt/locale/pigeoin_cs.qm: src/qt/locale/pigeoin_cs.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_cs.ts -qm src/qt/locale/pigeoin_cs.qm

src/qt/locale/pigeoin_cy.qm: src/qt/locale/pigeoin_cy.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_cy.ts -qm src/qt/locale/pigeoin_cy.qm

src/qt/locale/pigeoin_da.qm: src/qt/locale/pigeoin_da.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_da.ts -qm src/qt/locale/pigeoin_da.qm

src/qt/locale/pigeoin_de.qm: src/qt/locale/pigeoin_de.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_de.ts -qm src/qt/locale/pigeoin_de.qm

src/qt/locale/pigeoin_el_GR.qm: src/qt/locale/pigeoin_el_GR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_el_GR.ts -qm src/qt/locale/pigeoin_el_GR.qm

src/qt/locale/pigeoin_en.qm: src/qt/locale/pigeoin_en.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_en.ts -qm src/qt/locale/pigeoin_en.qm

src/qt/locale/pigeoin_eo.qm: src/qt/locale/pigeoin_eo.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_eo.ts -qm src/qt/locale/pigeoin_eo.qm

src/qt/locale/pigeoin_es.qm: src/qt/locale/pigeoin_es.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_es.ts -qm src/qt/locale/pigeoin_es.qm

src/qt/locale/pigeoin_es_CL.qm: src/qt/locale/pigeoin_es_CL.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_es_CL.ts -qm src/qt/locale/pigeoin_es_CL.qm

src/qt/locale/pigeoin_et.qm: src/qt/locale/pigeoin_et.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_et.ts -qm src/qt/locale/pigeoin_et.qm

src/qt/locale/pigeoin_eu_ES.qm: src/qt/locale/pigeoin_eu_ES.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_eu_ES.ts -qm src/qt/locale/pigeoin_eu_ES.qm

src/qt/locale/pigeoin_fa.qm: src/qt/locale/pigeoin_fa.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_fa.ts -qm src/qt/locale/pigeoin_fa.qm

src/qt/locale/pigeoin_fa_IR.qm: src/qt/locale/pigeoin_fa_IR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_fa_IR.ts -qm src/qt/locale/pigeoin_fa_IR.qm

src/qt/locale/pigeoin_fi.qm: src/qt/locale/pigeoin_fi.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_fi.ts -qm src/qt/locale/pigeoin_fi.qm

src/qt/locale/pigeoin_fr.qm: src/qt/locale/pigeoin_fr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_fr.ts -qm src/qt/locale/pigeoin_fr.qm

src/qt/locale/pigeoin_fr_CA.qm: src/qt/locale/pigeoin_fr_CA.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_fr_CA.ts -qm src/qt/locale/pigeoin_fr_CA.qm

src/qt/locale/pigeoin_gu_IN.qm: src/qt/locale/pigeoin_gu_IN.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_gu_IN.ts -qm src/qt/locale/pigeoin_gu_IN.qm

src/qt/locale/pigeoin_he.qm: src/qt/locale/pigeoin_he.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_he.ts -qm src/qt/locale/pigeoin_he.qm

src/qt/locale/pigeoin_hi_IN.qm: src/qt/locale/pigeoin_hi_IN.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_hi_IN.ts -qm src/qt/locale/pigeoin_hi_IN.qm

src/qt/locale/pigeoin_hr.qm: src/qt/locale/pigeoin_hr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_hr.ts -qm src/qt/locale/pigeoin_hr.qm

src/qt/locale/pigeoin_hu.qm: src/qt/locale/pigeoin_hu.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_hu.ts -qm src/qt/locale/pigeoin_hu.qm

src/qt/locale/pigeoin_it.qm: src/qt/locale/pigeoin_it.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_it.ts -qm src/qt/locale/pigeoin_it.qm

src/qt/locale/pigeoin_ja.qm: src/qt/locale/pigeoin_ja.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_ja.ts -qm src/qt/locale/pigeoin_ja.qm

src/qt/locale/pigeoin_la.qm: src/qt/locale/pigeoin_la.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_la.ts -qm src/qt/locale/pigeoin_la.qm

src/qt/locale/pigeoin_lt.qm: src/qt/locale/pigeoin_lt.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_lt.ts -qm src/qt/locale/pigeoin_lt.qm

src/qt/locale/pigeoin_lv_LV.qm: src/qt/locale/pigeoin_lv_LV.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_lv_LV.ts -qm src/qt/locale/pigeoin_lv_LV.qm

src/qt/locale/pigeoin_nb.qm: src/qt/locale/pigeoin_nb.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_nb.ts -qm src/qt/locale/pigeoin_nb.qm

src/qt/locale/pigeoin_nl.qm: src/qt/locale/pigeoin_nl.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_nl.ts -qm src/qt/locale/pigeoin_nl.qm

src/qt/locale/pigeoin_pl.qm: src/qt/locale/pigeoin_pl.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_pl.ts -qm src/qt/locale/pigeoin_pl.qm

src/qt/locale/pigeoin_pt_BR.qm: src/qt/locale/pigeoin_pt_BR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_pt_BR.ts -qm src/qt/locale/pigeoin_pt_BR.qm

src/qt/locale/pigeoin_pt_PT.qm: src/qt/locale/pigeoin_pt_PT.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_pt_PT.ts -qm src/qt/locale/pigeoin_pt_PT.qm

src/qt/locale/pigeoin_ro_RO.qm: src/qt/locale/pigeoin_ro_RO.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_ro_RO.ts -qm src/qt/locale/pigeoin_ro_RO.qm

src/qt/locale/pigeoin_ru.qm: src/qt/locale/pigeoin_ru.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_ru.ts -qm src/qt/locale/pigeoin_ru.qm

src/qt/locale/pigeoin_sk.qm: src/qt/locale/pigeoin_sk.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_sk.ts -qm src/qt/locale/pigeoin_sk.qm

src/qt/locale/pigeoin_sr.qm: src/qt/locale/pigeoin_sr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_sr.ts -qm src/qt/locale/pigeoin_sr.qm

src/qt/locale/pigeoin_sv.qm: src/qt/locale/pigeoin_sv.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_sv.ts -qm src/qt/locale/pigeoin_sv.qm

src/qt/locale/pigeoin_th_TH.qm: src/qt/locale/pigeoin_th_TH.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_th_TH.ts -qm src/qt/locale/pigeoin_th_TH.qm

src/qt/locale/pigeoin_tr.qm: src/qt/locale/pigeoin_tr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_tr.ts -qm src/qt/locale/pigeoin_tr.qm

src/qt/locale/pigeoin_uk.qm: src/qt/locale/pigeoin_uk.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_uk.ts -qm src/qt/locale/pigeoin_uk.qm

src/qt/locale/pigeoin_zh_CN.qm: src/qt/locale/pigeoin_zh_CN.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_zh_CN.ts -qm src/qt/locale/pigeoin_zh_CN.qm

src/qt/locale/pigeoin_zh_TW.qm: src/qt/locale/pigeoin_zh_TW.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/pigeoin_zh_TW.ts -qm src/qt/locale/pigeoin_zh_TW.qm

compiler_moc_header_make_all: build/moc_pigeoingui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_sendcoinsdialog.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_pigeoinaddressvalidator.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_pigeoinamountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_walletview.cpp build/moc_walletstack.cpp build/moc_walletframe.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_pigeoinunits.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_paymentserver.cpp build/moc_rpcconsole.cpp build/moc_splashscreen.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_pigeoingui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_sendcoinsdialog.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_pigeoinaddressvalidator.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_pigeoinamountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_walletview.cpp build/moc_walletstack.cpp build/moc_walletframe.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_pigeoinunits.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_paymentserver.cpp build/moc_rpcconsole.cpp build/moc_splashscreen.cpp
build/moc_pigeoingui.cpp: src/qt/pigeoingui.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/pigeoingui.h -o build/moc_pigeoingui.cpp
...
build/moc_pigeoinaddressvalidator.cpp: src/qt/pigeoinaddressvalidator.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/pigeoinaddressvalidator.h -o build/moc_pigeoinaddressvalidator.cpp
...
build/moc_pigeoinamountfield.cpp: src/qt/pigeoinamountfield.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/pigeoinamountfield.h -o build/moc_pigeoinamountfield.cpp
...
build/moc_pigeoinunits.cpp: src/qt/pigeoinunits.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/pigeoinunits.h -o build/moc_pigeoinunits.cpp
...
compiler_rcc_make_all: qrc_pigeoin.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_pigeoin.cpp
qrc_pigeoin.cpp: src/qt/pigeoin.qrc \
		src/qt/locale/pigeoin_fr.qm \
		src/qt/locale/pigeoin_sk.qm \
		src/qt/locale/pigeoin_ca.ts \
		src/qt/locale/pigeoin_bs.ts \
		src/qt/locale/pigeoin_sr.qm \
		src/qt/locale/pigeoin_hi_IN.ts \
		src/qt/locale/pigeoin_sv.qm \
		src/qt/locale/pigeoin_la.ts \
		src/qt/locale/pigeoin_pt_BR.qm \
		src/qt/locale/pigeoin_da.qm \
		src/qt/locale/pigeoin_zh_CN.qm \
		src/qt/locale/pigeoin_he.qm \
		src/qt/locale/pigeoin_pl.qm \
		src/qt/locale/pigeoin_cs.qm \
		src/qt/locale/pigeoin_lv_LV.ts \
		src/qt/locale/pigeoin_de.qm \
		src/qt/locale/pigeoin_th_TH.ts \
		src/qt/locale/pigeoin_tr.qm \
		src/qt/locale/pigeoin_cy.ts \
		src/qt/locale/pigeoin_eu_ES.qm \
		src/qt/locale/pigeoin_fr_CA.qm \
		src/qt/locale/pigeoin_ca_ES.qm \
		src/qt/locale/pigeoin_lt.qm \
		src/qt/locale/pigeoin_zh_TW.qm \
		src/qt/locale/pigeoin_hr.qm \
		src/qt/locale/pigeoin_uk.qm \
		src/qt/locale/pigeoin_hu.qm \
		src/qt/locale/pigeoin_af_ZA.qm \
		src/qt/locale/pigeoin_es_CL.qm \
		src/qt/locale/pigeoin_pt_PT.qm \
		src/qt/locale/pigeoin_gu_IN.ts \
		src/qt/locale/pigeoin_ro_RO.qm \
		src/qt/locale/pigeoin_nb.qm \
		src/qt/locale/pigeoin_el_GR.qm \
		src/qt/locale/pigeoin_ja.ts \
		src/qt/locale/pigeoin_en.qm \
		src/qt/locale/pigeoin_eo.ts \
		src/qt/locale/pigeoin_it.qm \
		src/qt/locale/pigeoin_fa.qm \
		src/qt/locale/pigeoin_es.qm \
		src/qt/locale/pigeoin_et.qm \
		src/qt/locale/pigeoin_ar.qm \
		src/qt/locale/pigeoin_nl.qm \
		src/qt/locale/pigeoin_fa_IR.qm \
		src/qt/locale/pigeoin_fi.qm \
		src/qt/locale/pigeoin_bg.qm \
		src/qt/locale/pigeoin_ru.qm \
		...
		src/qt/res/icons/pigeoin_testnet.png \
	...
	/usr/lib/x86_64-linux-gnu/qt4/bin/rcc -name pigeoin src/qt/pigeoin.qrc -o qrc_pigeoin.cpp
...
build/pigeoin.o: src/qt/pigeoin.cpp src/qt/pigeoingui.h \
		src/qt/clientmodel.h \
		src/qt/walletmodel.h \
		src/allocators.h \
		src/qt/optionsmodel.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/pigeoin.o src/qt/pigeoin.cpp

build/pigeoingui.o: src/qt/pigeoingui.cpp src/qt/pigeoingui.h \
		src/qt/transactiontablemodel.h \
		...
		src/init.h \
		src/qt/macdockiconhandler.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/pigeoingui.o src/qt/pigeoingui.cpp
...
build/pigeoinaddressvalidator.o: src/qt/pigeoinaddressvalidator.cpp src/qt/pigeoinaddressvalidator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/pigeoinaddressvalidator.o src/qt/pigeoinaddressvalidator.cpp
...
build/pigeoinstrings.o: src/qt/pigeoinstrings.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/pigeoinstrings.o src/qt/pigeoinstrings.cpp

build/pigeoinamountfield.o: src/qt/pigeoinamountfield.cpp src/qt/pigeoinamountfield.h \
		src/qt/qvaluecombobox.h \
		src/qt/pigeoinunits.h \
		src/qt/guiconstants.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/pigeoinamountfield.o src/qt/pigeoinamountfield.cpp
...
build/pigeoinrpc.o: src/pigeoinrpc.cpp src/init.h \
		src/wallet.h \
		src/main.h \
		src/bignum.h \
		src/util.h \
		...
		src/json/json_spirit_writer_template.h \
		src/json/json_spirit_utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/pigeoinrpc.o src/pigeoinrpc.cpp
...
build/pigeoinunits.o: src/qt/pigeoinunits.cpp src/qt/pigeoinunits.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/pigeoinunits.o src/qt/pigeoinunits.cpp
...
build/moc_pigeoingui.o: build/moc_pigeoingui.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_pigeoingui.o build/moc_pigeoingui.cpp
...
build/moc_pigeoinaddressvalidator.o: build/moc_pigeoinaddressvalidator.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_pigeoinaddressvalidator.o build/moc_pigeoinaddressvalidator.cpp
...
build/moc_pigeoinamountfield.o: build/moc_pigeoinamountfield.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_pigeoinamountfield.o build/moc_pigeoinamountfield.cpp
...
build/moc_pigeoinunits.o: build/moc_pigeoinunits.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_pigeoinunits.o build/moc_pigeoinunits.cpp
...
build/qrc_pigeoin.o: qrc_pigeoin.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/qrc_pigeoin.o qrc_pigeoin.cpp
